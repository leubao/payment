 ...
 *
 * (c) xzusoft.com <xunzhou@leubao.com>
 *
 ...
 * @desc    : 易宝支付对外暴露的方案集合
 **/
class YeepayProxy extends BaseObject implements IPayProxy, IQueryProxy, ITransferProxy
{
    /**
     * 支付操作
    ...
    public function notify(IPayNotify $callback)
    {
        ...
        // 异步 async，同步 sync
        $flag = $callback->handle('Yeepay', $data['notify_type'], 'async', $data['notify_data']);
